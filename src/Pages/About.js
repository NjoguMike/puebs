      ...
      <div className='header'>
        ...
        <div className='intro'>
          <div className='intro_card'>
            <p>Digital Daktariz is an internet marketing firm that can provide you with the complete set of services you need to dominate your local market through online methods. With us, you get incredible web development, SEO <b><em>(search engine optimization)</em></b> services, and insight on how to utilize tools from Google and Facebook. Our focus is on helping businesses here in Digital Daktariz, Kenya use web development techniques to expand their customer base, increase sales, and retain customers for the long haul.</p>
            <p>For great <b><em>web development</em></b> in Digital Daktariz, Kenya, you need more than just a sleek website design. There are incredible web design teams that focus solely on the way your website looks, but when they are rooted in best SEO practices, mobile-friendly designs, click-to-call, and analytics, they don’t have the ability to reach an audience.</p>
            <p>
      ...
      <div className='team'>
        ...
        <div className='team_container'>
          <div className='team_card'>
            ...
            <p>Josh has been a master in the digital marketing space for over 10 years. Josh loves bringing major results to each and everyone of his customers. </p>
          </div>
          <div className='team_card'>
            <img src={profile_2} alt='about pic' />
            <h3>Joshua T. Osborne</h3>
