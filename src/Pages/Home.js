...
function Home() {
  return (
    <div className='main'>
        ...
        <section>
            <h3>Pueblo Seo Brings You the Complete Internet Marketing Package</h3>
        ...
        <section className='card_menu'>
            <div className='card'>
                <h3>SEO</h3>
                <p>Every single project we launch here at Pueblo marketing begins with a thorough, often intense planning process. We involve as many of our in-house experts as needed to ensure that your plan is sound and successful. </p>
